...
public class BlockBag extends com.sk89q.worldedit.bags.BlockBag {
	private final EntityPlayer player;
	
	public BlockBag(EntityPlayer player) {
		this.player = player;
	}
	...
	public void storeItem(BaseItem item) throws BlockBagException {
        if (!player.inventory.addItemStackToInventory(WorldEditUtils.baseItemStackToStack(item))) {
